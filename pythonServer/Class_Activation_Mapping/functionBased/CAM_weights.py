...
def joint_weights_cam(dataset, save_weights=True):
    ...
    if save_weights == True:
        np.save("Class_Activation_Mapping/"+str(dataset) + '_cam_joint_weights.npy', weights)
        print("Saving:", str(dataset) + '_cam_joint_weights.npy')
