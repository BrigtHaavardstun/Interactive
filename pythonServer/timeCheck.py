...
from load_dataset.load_data import load_dataset, convert_sep_files, normalize_data, train_test_split_both
...
def test_pred_new(data_set, instance):
    ...
    interpreter = tflite.Interpreter(
        model_path="Blackbox_classifier_FCN/LITE/ItalyPowerDemand.tflite")
    ...
    input_arr = instance
    input_arr = input_arr.reshape(1, 24, 1)
...
def org_way(data_set, instance):
    ...
    preds = model.predict(instance.reshape(1, 24, 1))
    return preds
